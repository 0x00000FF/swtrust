...
pub const NUM_POLICY_PCR_GROUP: u16 = 1;
/// Number of PCR groups that have individual authorization values.
pub const NUM_AUTHVALUE_PCR_GROUP: u16 = 1;
...
pub const VENDOR_TPM_TYPE: u32 = 1;
...
pub const DEFAULT_PCR_BANKS: &[u16] = &[alg::SHA1, alg::SHA256];
...
pub const IMPLEMENTED_RSA_KEY_BITS: &[u16] = &[1024, 2048, 3072, 4096];
